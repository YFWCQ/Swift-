//
//  FYBaseRefreshTableViewController.h
//  FYRefresh
//
...
@interface FYBaseRefreshTableViewController : FYBaseViewController<FYRefreshViewDelegate,UITableViewDataSource,UITableViewDelegate>

/**
 *  上拉刷新 下拉加载的 UITableView
 */
@property(nonatomic,retain)FYRefreshTableView * baseTableView;
